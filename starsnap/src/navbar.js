                    ...
                    <Flex justify="space-between">
                        ...
                        <Flex justify="center" flex={1} align="center">
                            <ButtonGroup variant="ghost" spacing="8">
                                <Button as="a" href="/learn" leftIcon={<Icon as={FaGraduationCap} boxSize="1.5em" />} variant={props.currentPage === "learningTab" ? "solid" : "ghost"}>Learning Tab</Button>
                                <Image transition="box-shadow 0.3s ease-in-out" display="inline" onMouseDown={() => props.currentPage != "identificationTab" ? Navigate("/identify") : null} boxSize="6em" src={cameraIcon} _hover={{ border: "2px", boxShadow: "dark-lg" }} border="1px" boxShadow="lg" borderRadius={1000000} />
                                <Button as="a" href="/" leftIcon={<Icon as={FaComments} boxSize="1.5em" />} variant={props.currentPage === "forum" ? "solid" : "ghost"}>Forum</Button>
